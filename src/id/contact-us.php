...
<html lang="id" dir="ltr">
  <head>
    ...
    <meta name="description" itemprop="description" content="Untuk konsultasi mengenai berbagai layanan kami mulai dari sistem infrastruktur IT, operasi dan penanggulangan sistem komputer, sampai outsourcing/pengalihdayaan, silakan hubungi PT SCSK Global Indonesia.">
    <meta name="keywords" content="hubungi scsk indonesia, alamat scsk indonesia, nomor telepon scsk indonesia, kontak scsk indonesia, cara menghubungi scsk indonesia, kerja sama scsk indonesia, scsk cabang indonesia">
    <meta property="og:title" content="Kontak Kami | PT SCSK GLOBAL INDONESIA">
    <meta property="og:description" content="Untuk konsultasi mengenai berbagai layanan kami mulai dari sistem infrastruktur IT, operasi dan penanggulangan sistem komputer, sampai outsourcing/pengalihdayaan, silakan hubungi PT SCSK Global Indonesia.">
		<meta name="google-site-verification" content="ynliGJT41FwiTUHHCllMLqmkzroVda0m3wV0kYFZ-Pw" />
		<link href="../assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="../assets/css/style.css" rel="stylesheet" type="text/css" />
    <link rel="shortcut icon" href="../favicon.ico" />
    <title>Kontak Kami | PT SCSK GLOBAL INDONESIA</title>
  </head>
  <body>
    <?php
    ...
    <section class="mt-45px">
      <div class="heading max-w-650 mb-5">
        <h1 class="blue-heading text-center">Hubungi Kami</h1>
        <?php /* <p class="text-center mobile-font-20">Silakan isi formulir di bawah ini untuk informasi lebih lanjut dan kami akan segera menghubungi Anda</p> */ ?>
      </div>
        ...
        <div class="custom-container">
          <div class="contact-location">
            ...
            <div class="blue-box mb-3 mb-md-0 mt-5 mt-md-0">
              ...
              <p class="mb-40px">Alamat: <br>SUMMITMAS II 5th Floor, JL. Jenderal Sudirman Kaveling 61-62, Jakarta Selatan 12190 Indonesia</p>
	        ...
	        <div class="contact-form max-w-650">
	          ...
	          <form action="" method="post" id="contact-form">
	            <div class="form-group">
	              ...
	              <input id="full-name" class="contact-input" type="text" name="name" value="<?= !empty($errors) ? $_POST['name'] : ''?>" required placeholder="Nama lengkap Anda">
	            </div>
	            <div class="form-group">
	              <label for="company">Perusahaan*</label>
	              <input id="company" class="contact-input" type="text" name="company" value="<?= !empty($errors) ? $_POST['company'] : ''?>" required placeholder="Nama Perusahaan Anda">
	            </div>
	            <div class="form-group">
	            ...
	            <div class="form-group">
	              ...
	              <textarea id="message" name="message" placeholder="Kami ingin mendapatkan informasi tentang…"><?= !empty($errors) ? $_POST['message'] : ''?></textarea>
				</div>
	            ...
	            <div class="text-center">
	              <button id="contactbtn" style="padding: 8px 36px;" class="sm-rect-blue" type="submit" name="button" data-loading-text="<i class='fa fa-spinner fa-spin'></i>">Kirim</button>
	            </div>
	          </form>
	        </div>
				</div> */?>
