      ...
      <nav class="navbar navbar-expand-md navbar-menu">
        ...
        <div class="d-flex flex-grow-1 justify-content-end">
          ...
          <ul class="language-links">
            ...
            <li>
              <a class="lang-active" href="<?php echo $LangLink[1]; ?>">
                ID
              </a>
            </li>
            <li>
    ...
    <div class="collapse navbar-collapse" id="navbar-links">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="./#service">Layanan</a>
          <div class="dropdown-menu" aria-labelledby="about-us-dropdown">
            <a class="dropdown-item" href="./system-architecture.php">Sistem Konstruksi</a>
            <a class="dropdown-item" href="./it-infrastructure-architecture.php">Infrastruktur IT</a>
            <a class="dropdown-item" href="./operation-maintenance.php">Pengerjaan dan Pemeliharaan</a>
            <a class="dropdown-item" href="./security.php">Keamanan</a>
            <a class="dropdown-item" href="./consultation.php">Konsultasi</a>
            <a class="dropdown-item" href="./outsourcing.php">Outsourcing</a>
            <a class="dropdown-item" href="./celf.php">Tool Pengembangan Tanpa Coding : CELF</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="about-us-dropdown">
            <a class="dropdown-item" href="./about-us.php#company-profile">Profil Perusahaan</a>
            <a class="dropdown-item" href="./about-us.php#company-philosophy">Filosofi Perusahaan</a>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link font-15" href="./contact-us.php">Kontak Kami</a>
        </li>
